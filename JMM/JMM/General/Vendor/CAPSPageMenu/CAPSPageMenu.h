...
// add by ZJ 判断当前视图是否滚动到左右边界
- (void)pageMenuScrollView:(UIScrollView *)scrollView didScrollToLeftBoundary:(BOOL)left;
- (void)pageMenuScrollView:(UIScrollView *)scrollView didScrollToRightBoundary:(BOOL)right;
@end
...
@property (nonatomic) CGFloat selectionIndicatorBottomMargin;
...
@property (nonatomic) BOOL needSetStartMargin;
...
extern NSString * const CAPSPageMenuOptionSelectionIndicatorBottomMargin;
...
extern NSString * const CAPSPageMenuOptionNeedSetStartMargin;   ///需要设置起始的Margin
@end
